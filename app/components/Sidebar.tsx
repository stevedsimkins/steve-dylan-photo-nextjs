...
export default function Sidebar(){
  return (
    <div className="hidden h-screen w-1/5 min-w-max lg:flex flex-col justify-start ml-4 my-2 gap-6">
      <div className="mb-8">
      ...
      <Link className="font-ebGaramond text-2xl hover:underline " href="#">About</Link>
      <Link className="font-ebGaramond text-2xl hover:underline " href="#">Contact</Link>
    </div>
  )
}
